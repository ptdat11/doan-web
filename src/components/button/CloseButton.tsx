...
const CloseButton: React.FC<Props> = React.memo((props) => {
    return (
        ...
        >
            ...
            <path className="group-hover:stroke-white" d="M18 18L12 12M12 12L6 6M12 12L18 6M12 12L6 18" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </button>
    );
});
