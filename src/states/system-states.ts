...
export type MilanoAPI = "register" | "login" | "token/refresh" | "profile" | "validate-username" | "products" | "product" | "categories" | "cart" | "cart/add" | "cart/convert-to-order" | "remove-from-cart";
